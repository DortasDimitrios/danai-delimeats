...
import style from '../styles/Post4.css';
import Post401 from '../images/post401.jpg';
        ...
        return(
            <div>
                <div className='left-side'>
                    <h4 className='welcome-rec'>Αλλαντικά κατηγορίες</h4>
                    

                    <div className='image-wrapper-post4'>
                    <Menu />
                    </div>
...
<br></br>
                             ...
                             <h3>Διαβάστε το σωστό τρόπο να επιλέγετε αλλαντικά εδώ: <Link to='/blog/6-basic-rules'> 6 Βασικοί κανόνες για να επιλέξετε αλλαντικά</Link></h3>
                             <br></br>
<br></br>
<br></br>
